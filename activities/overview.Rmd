...
<iframe width="100%" height="705" frameborder="0"
...
When we read in the data, the graph was undirected. A -> B means that B -> A.
...
attracted a bit of attention in the data science blogosphere. What is it about
their work (its subject matter, design, execution, ...) that makes it stand out?
What ideas might you be able to borrow for your projects (or your future work)?
