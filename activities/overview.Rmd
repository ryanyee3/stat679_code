...
1. New inputs / outputs we didn't cover in class (e.g., `eventReaction()`)
...
Q: New inputs / outputs we didn't cover in class (e.g., `eventReaction()`)
 
  1. The best places to find documentation: 
  1. Users can contribute their own inputs / outputs. Increases complexity, but
