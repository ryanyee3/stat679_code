...
1. When D3 was introduced, it recommended creating, modifying, and deleting
elements using a "general update pattern", and this is still found in most
introductions to D3, e.g.,
