...
to support the literature review for your course project.
	...
	[VAST](https://ieeexplore.ieee.org/xpl/conhome/1001630/all-proceedings), or
	(iv) go to the home pages of researchers chairing conference sessions related
	to your keywords.
...
1. [Shiny free exploration] Pick one of the following datasets,

  * [London Olympics](https://uwmadison.box.com/s/rzw8h2x6dp5693gdbpgxaf2koqijo12l)
  * [Pokemon](https://uwmadison.box.com/shared/static/hf5cmx3ew3ch0v6t0c2x56838er1lt2c.csv)
  * [Chicago Traffic Accidents](https://raw.githubusercontent.com/krisrs1128/stat479_s22/main/_slides/week9/exercises/chicago_crashes.csv)
  * [Australian Pharmaceuticals](https://uwmadison.box.com/shared/static/fcy9q1uleqru7gcs287q903y0rcnw2a2.csv)

  or propose one based on your own interest.
...
1. These are some exercises to prepare you for more complex array and object manipulation that you may need in more advanced D3 visualizations. You will likely find the following resources useful: [[1](https://github.com/d3/d3-array), [2](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global\_Objects/Array/slice), [3](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global\_Objects/Set), [4](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global\_Objects/Object/keys)].
  ...
  b. Extracts the first 5 elements of `x` and then concatenate them to the last
  5 elements of `y`.
  ...
  Your result should look like `[0, 1, 2, 3, 4, 15, 16, 17, 18, 19]`.
...
1. 1. [Interactive Census] The code below creates a bar chart of US female
...
1. [D3 free exploration] Pick one of the following datasets:
