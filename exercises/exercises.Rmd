...
should be entered from the left of the Canvas, and all bars should move to the
right to make space for them. Once a bar can no longer be displayed on the page,
...
pattern. The code at [this link](https://github.com/krisrs1128/stat679_code/blob/main/activities/week5/demo5-1-starter.js)
...
underlying data changes.
  ...
  e. Modify your implementation so that the y-coordinate positions of the
  circles move along a sine curve.
...
1. [General Update Pattern] The general update pattern is one of the central,
but also most complex, concepts relevant to D3 programming. This exercise asks
you to reflect on your understanding of this concept.
  
  a. Explain one situation where the general update pattern might be used. Your
  application may be to an animation or interactive visualization, for example.
  Be as specific as possible.
  b. Sketch the pseudocode that implements a version of the general update pattern
  that could potentially be used in the example you outlined in part (a). Give
  an explanation of the main parts of your pseudocode.
...
updates to this data structure.
  ...
  reflect the motion of the circles. Hint: For paths with only two endpoints,
  you may use the [`line` SVG element](https://developer.mozilla.org/en-US/docs/Web/SVG/Element/line).
