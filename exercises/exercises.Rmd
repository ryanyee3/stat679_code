...
1. [Visual Complexity] In this problem, we will analyze a visualization hosted on the website [visualcomplexity](<http://www.visualcomplexity.com/vc/>) using the language we’ve developed in class. Briefly respond to each of the queries below.
