...
similar bugs.
    ...
    Attempt: Here is my [HTML](https://github.com/krisrs1128/stat679_code/blob/main/activities/week4/in_class4-2d.html) and [JS](https://github.com/krisrs1128/stat679_code/blob/main/activities/week4/in_class4-2d.html) file. This is the part that I think is relevant,
    ```{r, eval = FALSE}
    d3.select("#my_circle")
      .attrs({ x: 100, y: 200 })
    ```
