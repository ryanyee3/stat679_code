...
* a - d, Discussion for role (2/3 points each): Complete and accurate
description of function (2/3 points), generally correct but either vague or
copied from notes (1/3 points), incorrect or incomplete (0 points)
* a - d, Discussion for example (2/3 points each): Creative and clearly
explained scenario (2/3 points), correct but vague or copied from notes (1/3
...
* a - b, Discussion (0.75 points each): Well-developed and accurate descriptions
(0.75 point), correct but somewhat underdeveloped (0.5 points), missing
discussion (0 points).
* c, Design (0.75 points): Creative and readable design (0.5 points), generally
appropriate but lacking critical attention (0.5 points), difficult to read (0
points).
* c, Discussion (0.75 points): Well-developed and accurate descriptions (0.75
