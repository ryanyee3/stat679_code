...
inter-department similarities.
	...
	[Show the updated dimensionality reduction for petroleum engineering]
...
abstraction. It makes it possible to navigate large-scale data while supporting
...
topic models or in machine learning more generally.
