...
`d3.zoom()`. These are used to construct functions that can then
...
function zoom_fun(ev) {
  d3.select("svg").attr("transform", ev.transform);
    ...
    <iframe src="https://krisrs1128.github.io/stat679_code/examples/week10/week10-2/pan-zoom.html" data-external="1" height=300 width=600></iframe>
...
and other nodes get dragged along.
    ...
    <iframe src="https://krisrs1128.github.io/stat679_code/examples/week10/week10-2/miserables-zoom.html" data-external="1" height=300 width=600></iframe>
...
long-range interactions between nodes far from the lens.
    ...
    <iframe src="https://krisrs1128.github.io/stat679_code/examples/week10/week10-2/miserables-lens.html" data-external="1" height=300 width=600></iframe>
...
d3.select("#lens")
  ...
  .attrs({
    ...
    and whenever the mose moves, we call a function that will update the display.
