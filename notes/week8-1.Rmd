...
[Code](https://github.com/krisrs1128/stat679_code/tree/main/examples/week8/week8-1), [Recording]()
...
by setting their `d` attributes to strings like`M 100 100 L 200 105 L 300 115 `.
This means to start a path at pixel coordinates (100, 100), move to the right
and down by (200, 105) pixels, and so on. For a larger time series dataset, it
...
for full shaded areas rather than isolated lines.
    ...
    This area generator can be used to create the D3 streamgraph by binding the
