...
[Code](https://github.com/krisrs1128/stat679_code/blob/main/notes/week3-2.Rmd), [Recording]()

[Recording](),  [Rmarkdown](https://github.com/krisrs1128/stat679_code/blob/main/notes/week3-2.Rmd)
...
subset of rows that have been currently brushed.
    ...
    ```{r code=readLines("https://raw.githubusercontent.com/krisrs1128/stat479_s22/main/_posts/2022-02-16-week05-02/apps/app3.R")}
    ```
...
contexts, leading to changes in both plots every time the brush is moved.
    ...
    ```{r code=readLines("https://raw.githubusercontent.com/krisrs1128/stat479_s22/main/_posts/2022-02-16-week05-02/apps/app4.R")}
    ```
