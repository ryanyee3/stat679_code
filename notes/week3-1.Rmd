...
[Recording](),  [Rmarkdown](https://github.com/krisrs1128/stat679_code/blob/main/notes/week3-1.Rmd)
...
clicked.
    ...
    ```{r code=readLines("https://raw.githubusercontent.com/krisrs1128/stat479_s22/main/_posts/2022-02-16-week05-01/apps/app1.R")}
    ```
...
distance each time the plot is clicked.
    ...
    ```{r code=readLines("https://raw.githubusercontent.com/krisrs1128/stat479_s22/main/_posts/2022-02-16-week05-01/apps/app2.R")}
    ```
