...
[Code](https://github.com/krisrs1128/stat679_code/tree/main/examples/week12/week12-2.Rmd), [Recording]()
...
that discriminate between topics k and l, we compute
		D(k,l):=βkwlog(βkwβlw)+(βlw−βkw)
	for each word w. By maximizing over all pairs k,l, we can determine whether the
	word is discriminative between any pair of topics. This might seem like a
